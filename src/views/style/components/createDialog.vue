  ...
  <div class="style-dialog">
    <el-dialog title="风格" :visible.sync="dialogFormVisible" width="600px" :before-close="handleClose">
      <el-form ref="styleForm" :rules="rules" :model="params"  label-position="left" label-width="80px">
        <el-form-item label="风格名称" class="is-required">
          <el-input v-model="params.name"></el-input>
        </el-form-item>
        <el-form-item label="小图" class="is-required">
          <el-input v-model="params.name"></el-input>
          <!-- <UploadEdit
            v-if="policy"
            idkey="evidenceImages"
            :imgs="params.evidenceUrls"
            :policy="policy"
            :pic-type="0"
            @change="changeImgs"
          /> -->
        </el-form-item>
         <el-form-item label="大图" class="is-required">
          <el-input v-model="params.name"></el-input>
        </el-form-item>
